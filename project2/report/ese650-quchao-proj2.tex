...
\end{align}
where $\vec{a}_{bias}$ is $[511.5,\;511.5,\;511.5]$ and $\vec{\omega}_{bias}$ is determined empirically by averaging the first 100 readings of one of the IMU data and is $[373.63\;, 375.20\;, 369.66]$. $s_{a}$ and $s_{\omega}$ are the scale factors and their values are $0.0106$ and $0.0171$.
